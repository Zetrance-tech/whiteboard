...
export const generateMistralResponse = async (
  ...
  try {
    ...
    const diagramPrompt = `You are ZeLearn AI, a diagram and layout expert trained to generate structured visuals using Fabric.js-compatible JSON. Your output must render an accurate, well-aligned diagram using only supported object types: rect, circle, text, line, and path.
